...
from encoders import convolution_with_linear_softmax
...
def train(configuration: dict) -> None:
    ...
    # the model to train
    model = ProtoNetTUF.build_network(encoder=convolution_with_linear_softmax(in_channels=2, out_channels=1, kernel_size=1,
